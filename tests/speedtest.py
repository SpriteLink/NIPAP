...
class bonk:
	def __init__(self):
		...
		self.n.remove_prefix({ 'schema_name': 'test-schema', 'prefix': '1.0.0.0/8' })
		self.n.add_prefix({ 'authoritative_source': 'nap', 'schema_name': 'test-schema', 'prefix': '1.0.0.0/8', 'description': 'test' })
...
if __name__ == '__main__':
	...
	b.test3()
	import timeit
	t = timeit.Timer("s.test3()", "from __main__ import bonk\ns = bonk()")
